...
')
     ...
     */ 
        ...
        {
                        /** @var \App\Services\DocumentService $instance */
                        return $instance->addScriptVar($key, $value);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function addMetas($name, $content = '')
        {
                        /** @var \App\Services\DocumentService $instance */
                        return $instance->addMetas($name, $content);
        }
                    /**
         * 
         *
        ...
        {
                        /** @var \App\Services\DocumentService $instance */
                        return $instance->setTitle($value);
        }
                    /**
         * 
         *
        ...
        {
                        /** @var \App\Services\DocumentService $instance */
                        return $instance->setDescription($value);
        }
                    /**
         * 
         *
     ...
     */ 
        ...
        {
                        /** @var \App\Services\CurrencyService $instance */
                        return $instance->format($number, $currency, $value, $format);
        }
     ...
     */ 
         ...
         * @static 
         */ 
        public static function telLink($phone)
        {
                        /** @var \App\Services\FunctionsService $instance */
                        return $instance->telLink($phone);
        }
                    /**
         ...
         * @static 
         */ 
        public static function getYoutubeVideoId($pageVideUrl)
        {
                        /** @var \App\Services\FunctionsService $instance */
                        return $instance->getYoutubeVideoId($pageVideUrl);
        }
                    /**
         * 
         *
     ...
     */ 
        ...
        {
                        /** @var \App\Services\Thumb\ThumbService $instance */
...
namespace  { 
            ...
            class Document extends \App\Facades\DocumentFacade {}
            class Currency extends \App\Facades\CurrencyFacade {}
            class Functions extends \App\Facades\FunctionsFacade {}
            class Thumb extends \App\Facades\ThumbFacade {}
